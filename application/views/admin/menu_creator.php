...
<?php foreach($columns as $column){ ?>
<td <?php if(isset($column['align']) && $column['align']!='') echo 'class="'.$column['align'].'"'; ?>><?php if(isset($column['params']) && $column['params']!='') echo prepareCellData($scrudID,$this->router->fetch_class(),$row,$column['params']); else echo $row[$column['name']]; ?></td>
<?php } ?>
<td>
